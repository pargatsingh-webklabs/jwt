        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-title">   <?php echo $userdata["fname"]." ".$userdata["lname"];?> Dashboard</h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-center col-sm-4">
                                            <div class="single_stat_data">
                                                ...
                                                <p>Total
                                                    <span>Earnings</span> This Month</p>
                                            </div>
                                        </div>
                                ...
                                <div class="chart_top">
                                    <div class="v_refer">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li>
                                                <a href="#visit_source" class="active" aria-controls="visit_source" role="tab" data-toggle="tab">Visit Source</a>
                                            </li>
                                            <li>
