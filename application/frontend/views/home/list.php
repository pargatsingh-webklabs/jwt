 ...
 <!--============================================
                    ...
                    <div class="item-preview">
                        <div class="item__preview-slider">
                            <div class="prev-slide">
                                <img src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/itprv.jpg" alt="Keep calm this isn't the end of the world, the preview is just missing.">
                            </div>
                            <div class="prev-slide">
                                <img src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/itprv.jpg" alt="Keep calm this isn't the end of the world, the preview is just missing.">
                            </div>
                            ...
                            <div class="prev-thumb">
                                <div class="thumb-slider">
                                    <div class="item-thumb">
                                        <img src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/thumb1.jpg" alt="This is the thumbnail of the item">
                                    </div>
                                    <div class="item-thumb">
                                        <img src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/thumb2.jpg" alt="This is the thumbnail of the item">
                                    </div>
                                    <div class="item-thumb">
                                        <img src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/thumb3.jpg" alt="This is the thumbnail of the item">
                                    </div>
                                    <div class="item-thumb">
                                        <img src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/thumb4.jpg" alt="This is the thumbnail of the item">
                                    </div>
                                    <div class="item-thumb">
                                        <img src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/thumb5.jpg" alt="This is the thumbnail of the item">
                                    </div>
                                    <div class="item-thumb">
                                        <img src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/thumb1.jpg" alt="This is the thumbnail of the item">
                                    </div>
                        ...
                        <div class="tab-content">
                            <div class="fade show tab-pane product-tab active" id="product-details">
                                <div class="tab-content-wrapper">
                                    ...
                                    <img src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/prodesc.jpg" alt="This is product description thumbnail">
                                ...
                                <div class="thread">
                                    <ul class="media-list thread-list">
                                        <li class="single-thread">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#">
                                                        <img class="media-object" src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/m1.png" alt="Commentator Avatar">
                                                    </a>
                                                </div>
                                            ...
                                            <ul class="children">
                                                <li class="single-thread depth-2">
                                                    <div class="media">
                                                        <div class="media-left">
                                                            <a href="#">
                                                                <img class="media-object" src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/m2.png" alt="Commentator Avatar">
                                                            </a>
                                                        </div>
                                                        <div class="media-body">
                                                            <div class="media-heading">
                                        ...
                                        <li class="single-thread">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#">
                                                        <img class="media-object" src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/m3.png" alt="Commentator Avatar">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <div>
                                        ...
                                        <li class="single-thread">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#">
                                                        <img class="media-object" src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/m4.png" alt="Commentator Avatar">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <div>
                                        ...
                                        <li class="single-thread">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#">
                                                        <img class="media-object" src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/m5.png" alt="Commentator Avatar">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <div>
                                    ...
                                    <div class="comment-form-area">
                                        ...
                                        <div class="media comment-form">
                                            <div class="media-left">
                                                <a href="#">
                                                    <img class="media-object" src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/m7.png" alt="Commentator Avatar">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <form action="#" class="comment-reply-form">
                                    ...
                                    <ul class="media-list thread-list">
                                        ...
                                        <li class="single-thread">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#">
                                                        <img class="media-object" src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/m6.png" alt="Commentator Avatar">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <div class="clearfix">
                                        ...
                                        <li class="single-thread">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#">
                                                        <img class="media-object" src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/m8.png" alt="Commentator Avatar">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <div class="clearfix">
                                        ...
                                        <li class="single-thread">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#">
                                                        <img class="media-object" src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/m9.png" alt="Commentator Avatar">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <div class="clearfix">
                        ...
                        <div class="author-card sidebar-card ">
                            ...
                            <div class="author-infos">
                                <div class="author_avatar">
                                    <img src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/author-avatar.jpg" alt="Presenting the broken author avatar :D">
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product__thumbnail">
                            <img src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/p4.jpg" alt="Product Image">
                            <div class="prod_btn">
                        ...
                        <div class="product-desc">
                            ...
                            <ul class="titlebtm">
                                <li>
                                    <img class="auth-img" src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/auth3.jpg" alt="author image">
                                    <p>
                                        <a href="#">AazzTech</a>
                                    </p>
                                </li>
                                <li class="product_cat">
                                    <a href="#">
                                        <img src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/cathtm.png" alt="category image">Plugin</a>
                                </li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product__thumbnail">
                            <img src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/p2.jpg" alt="Product Image">
                            <div class="prod_btn">
                                <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                                <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                            </div>
                        ...
                        <div class="product-desc">
                            ...
                            <ul class="titlebtm">
                                <li>
                                    <img class="auth-img" src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/auth2.jpg" alt="author image">
                                    <p>
                                        <a href="#">AazzTech</a>
                                    </p>
                                </li>
                                <li class="product_cat">
                                    <a href="#">
                                        <img src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/catword.png" alt="category image">wordpress</a>
                                </li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product__thumbnail">
                            <img src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/p6.jpg" alt="Product Image">
                            <div class="prod_btn">
                                <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                                <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                            </div>
                        ...
                        <div class="product-desc">
                            ...
                            <ul class="titlebtm">
                                <li>
                                    <img class="auth-img" src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/auth.jpg" alt="author image">
                                    <p>
                                        <a href="#">AazzTech</a>
                                    </p>
                                </li>
                                <li class="product_cat">
                                    <a href="#">
                                        <img src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/catph.png" alt="Category Image">PSD</a>
                                </li>
                            </ul>
    ...
    <section class="call-to-action bgimage">
        <div class="bg_image_holder">
            <img src="<?php echo FRONT_END_LAYOUT; ?>/assets/images/calltobg.jpg" alt="">
        </div>
