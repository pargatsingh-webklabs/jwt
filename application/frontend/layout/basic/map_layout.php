...
<html xmlns="http://www.w3.org/1999/xhtml">
	<?php include("includes/map/head.php"); ?>
		...
		?>
		<body class="skin-blue sidebar-mini sidebar-collapse " id="map_load">
...
<div class="wrapper">			
		<?php include('includes/map/navigation.php'); ?>		
		...
		<!-- END CONTENT -->
		<?php include("includes/map/footer.php"); ?>
	</div>
	</body></html>	