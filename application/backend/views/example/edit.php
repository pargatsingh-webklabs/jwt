...
<div class="body">
							<form id="example_video" action="<?php echo BASEURL ?>/example/edit/<?php echo $getexample['id']; ?>" method="post" enctype="multipart/form-data">
...
<div class="row clearfix">
	<div class="col-sm-12">
		<div class="form-group">
			<div class="form-line">
			<input type="hidden" name="id" value="<?php echo $getexample['id']; ?>"/>
				<input type="text" class="form-control" value="<?php echo $getexample['title']; ?>" name="title"/>
			</div>
		</div>
	</div>
</div>
	...
	<div class="col-sm-12">
		<div class="form-group">
			<div class="form-line">
				<textarea rows="4" class="form-control no-resize" name='link'><?php echo $getexample['link']; ?></textarea>
			</div>
		</div>
	</div>
								</div>
