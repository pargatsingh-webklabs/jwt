                            ...
                            <table class="table table-striped table-bordered" width="100%" cellspacing="0" id="myTable">
								...
								<?php $srno=1;
                                    ...
                                    <tr>									
                                        ...
                                        <td><?php echo $srno++ ; ?></td>
                                        <td><b style="color: #8bc34a !important;">
											<?php 
												
												echo $category_name = get_sub_cate_parent($category['parent']);
										...
										<td>
<span style="background-color:#<?php echo $category['color_code'] ; ?>;color:#<?php echo $category['color_code'] ; ?>;border-radius:5px">AB</span>
											&nbsp;<b> <?php echo $category['color_code'] ; ?></b></td>
                                        <td>
...
<a href="<?php echo BASEURL ?>/categories/edit_sub_cate/<?php echo $category['id'] ?>"><i class="material-icons" style="color:#8bc34a !important;">mode_edit</i></a>											
<a title="Delete" onclick="return confirm('Are you sure you want to delete this category and its locations ')" href="<?php echo BASEURL ?>/categories/delete_sub_category/<?php echo $category['id'] ?>"><i class="material-icons" style="color:#DB4D4D;">delete</i></a>		
