	     ...
	     <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                             <form role="form" action="<?php echo BASEURL; ?>/categories/sub_categories" id='sub_categories_validation' method='post'>
                                <div class="row clearfix">
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                       <!-- <div class="form-group">
										...
										<select class="form-control show-tick" name="color_code">

										<option value="" >Select your color code</option>
										<?php foreach($colours as $key=>$val){?>
										<option style="background-color:#<?php echo $val['colour'] ; ?>;text-align:center" value="<?php echo $val['colour'] ?>" >
											<?php echo $val['colour'] ?></option>
										<?php } ?>
										</select>										
                                    </div>
