...
<i class="fa fa-arrow-left"></i>&nbsp;               
 ...
 <!-- left column -->
      ...
      <div class="col-md-3">
		...
		<div id="show_image">
          <img src="<?php echo $edit_testimonial['testimonial_image'] ;?>" class="avatar img-responsive img-circle" alt="avatar">
		  </div>
      ...
      <form id='form_edit_testimonial' name='form_edit_testimonial' method="post" action='<?php echo BASEURL; ?>/cms/edit_testimonial' class="form-horizontal" role="form"/>
	 ...
	 <div class="col-md-12 col-sm-12 col-xs-12">
	  ...
	  <div class="col-md-12 col-sm-12 col-xs-12">
		 <div class="form-group">
		   ...
		   <input type="text" name="testimonial_title" class="form-control" value="<?php echo $edit_testimonial['testimonial_title'] ;?>" />
	  </div>
	 </div>	
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		 <div class="form-group">
		   <label>Testimonial Description</label>
		    <textarea name="testimonial_description" class="form-control" ><?php echo $edit_testimonial['testimonial_description'] ;?></textarea>
	  </div>
	 </div>
