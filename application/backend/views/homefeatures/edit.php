...
<div class="body">
							<form id="home_features" action="<?php echo BASEURL ?>/homefeatures/edit/<?php echo $getfeatures['id']; ?>" method="post" enctype="multipart/form-data">
	...
	<div class="col-sm-6">
		<div class="form-group">
			<div class="form-line">
				...
				<input type="text" class="form-control" value="<?php echo $getfeatures['heading']; ?>" name="heading"/>
			</div></div>
	</div>
	<div class="col-sm-6">
		<div class="form-group">
			<div class="form-line">
				<input type="file" class="form-control" placeholder="image" name='image'/>
								...
								<div class="row clearfix"><div class="col-sm-12">
									<div class="form-group">
										<div class="form-line">
											<textarea rows="4" class="form-control no-resize" name='description'><?php echo $getfeatures['description']; ?></textarea>
										</div>
									</div>
									</div>
								</div>
