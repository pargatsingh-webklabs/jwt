...
<div class="body">
							<form id="home_features" action="<?php echo BASEURL ?>/homefeatures/edit/<?php echo $val['id']; ?>" method="post">
		...
		<div class="form-group">
			<div class="form-line">
				<input type="file" class="form-control" placeholder="image" />
								...
								<div class="row clearfix"><div class="col-sm-12"><div class="form-group"><div class="form-line"><textarea rows="4" class="form-control no-resize" placeholder="Description"></textarea></div></div></div></div>
		<button type="button" class="btn bg-red waves-effect">Submit</button>	
								<a href="<?php echo BASEURL ?>/homefeatures/" class="btn bg-grey waves-effect">Cancel</a>
							</form>
                        </div>
                    </div>
                </div>
