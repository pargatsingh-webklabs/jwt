        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Create post card</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Create Post card</li>
                            </ol>
           ...
           <form class="form-horizontal form-material" method="post" enctype="multipart/form-data" action="<?php echo BASEURL ; ?>/postcard/save">
                                   ...
                                   <div class="col-sm-12">
                                     <div class="form-group ">
                                        <label class="control-label">Description</label>
                                         <input id="firstName" class="form-control" name="description" placeholder="Birthday Postcard to Mom" type="text">
                                       </div> 
                                    </div>    
                                  <div class="col-sm-12">
                                    <div class="form-group">
                                     ...
                                     <div class="card">
                                        <div class="card-body">
                                            ...
                                            <label for="input-file-now">* Try some test files?</label>
                                             <input type="file" name="front_file_name"/>
<!--
                                      ...
                                      <div class="col-sm-12">
                                       <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        <input id="customRadio1" name="size" value="Free" class="custom-control-input" type="radio">
                                                        <label class="custom-control-label" for="customRadio1">Free</label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
                                                        <input id="customRadio2" name="size" value="Paid" class="custom-control-input" type="radio">
...
-->
                            ...
                            <div class="card-body">
                                ...
                                <label for="input-file-now">* Try some test files?</label>
                                <input type="file" name="back_file_name"/>
<!--
                                <div class="dropify-wrapper"><div class="dropify-message"><span class="fas fa-cloud-upload-alt"></span> <p>Drag and drop a file here or click</p><p class="dropify-error">Ooops, something wrong appended.</p></div><div class="dropify-loader"></div><div class="dropify-errors-container"><ul></ul></div><input id="input-file-now" class="dropify" type="file"><button type="button" class="dropify-clear">Remove</button><div class="dropify-preview"><span class="dropify-render"></span><div class="dropify-infos"><div class="dropify-infos-inner"><p class="dropify-filename"><span class="fas fa-cloud-upload-alt"></span> <span class="dropify-filename-inner"></span></p><p class="dropify-infos-message">Drag and drop or click to replace</p></div></div></div></div>
-->
                            </div>
