...
<div class="pull-right" style="padding:1%; "><a href="<?php echo BASEURL ?>/users/view_replacement_form/<?php echo $ID; ?>"  class="btn green">Go back to list</a></div>
<form  action="<?php echo BASEURL ?>/pdf" method="post" name="event_update">	
<input      type="hidden" name="form" value="replacement" /> 
<input      type="hidden" name="name" value="Property replacement request Form" /> 
<input      type="hidden" name="titlename" value="<?php echo  $request_form_data['escrow_number'] ; ?>"/> 	
<input      type="hidden" name="escrow_file_number" value="<?php echo  $request_form_data['escrow_file_number'] ; ?>"/> 	
...
<input    type="hidden" name="city" value="<?php echo $request_form_data['city']  ?> "/> 
<input    type="hidden" name="state" value="<?php echo $request_form_data['state']  ?> "/> 
<input    type="hidden" name="zipcode" value="<?php echo  $request_form_data['zipcode']  ?>" /> 
<input    type="hidden" name="current_time" value="<?php echo  date('m/d/Y', time())  ?>" /> 

	<div class="clearfix"></div>
<div id="commision-form1">

	<div id="replacement_form">
    <div class="panel">
    	<div class="row  col-border">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                    	<table width="100%" border="0" cellspacing="5" cellpadding="2">
                                <tr>
                                    <td>Date</td>
                                    <td><input   readonly   value="<?php echo  date('m/d/Y', $request_form_data['created']); ?>"  type="text" class="form-control" name="created" placeholder=""></td>
                                </tr>
                         </table>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    	<table width="100%" border="0" cellspacing="5" cellpadding="2">
                                <tr>
                                    <td>Escrow#</td>
                                    <td><input   readonly   value="<?php echo $request_form_data['escrow_number'] ; ?>"     type="text" class="form-control" name="escrow_number" placeholder=""></td>
                                </tr>
                         </table>
                    </div>
                </div>
          ...
          <!-- <div class="input-box">
          <input   readonly        type="text" class="form-control" name="username" placeholder=""  align="middle"></div>-->
           <span class="text-layout">This agreement is meant to replace the commission demand previously placed on the property located at</span>   
           <div class="input-box">
				<input   readonly   value="<?php echo $request_form_data['replaced_address'] ; ?>"     type="text" class="form-control" name="replaced_address" placeholder="" align="middle">
		   </div>  
		   <div class="clearfix"></div>
           <span class="text-layout">in escrow with</span> 
           
          <!-- <span class="text-layout">with a close date of</span>  --> 
		  <div class="input-box1">
				<input   readonly   value="<?php echo $request_form_data['closing_company_name'] ; ?>"     type="text" class="form-control" name="closing_company_name" placeholder=""  align="middle">
		   </div> 
           
           <span class="text-layout"> with a close date of</span>
           <div class="input-box1">
				<input   readonly   value="<?php echo  date('m/d/Y', $request_form_data['close_date']); ?>"     type="text" class="form-control" name="close_date" placeholder=""  align="middle">
		   </div> 
           <span class="text-layout">This property is not going to close escrow.The agreement below will supersede the previous agreement and the outstanding balance owed of</span>
          <!-- <span class="text-layout">from that agreement will be transferred to the property below.The amount owed will increase by $200 or 5% of the outstanding 			            balance whichever is greater.</span>
           -->
           <div class="input-box17">
				<input   readonly   value="<?php echo $request_form_data['sales_price'] ; ?>"     type="text" class="form-control" name="sales_price" placeholder=""  align="middle">
		   </div>
           <span class="text-layout">from that agreement will be transferred to the property below.The amount owed will increase by $200 or 5% of the outstanding 			            balance whichever is greater.</span>
		 <!--  <span class="text-layout"> (Advance)	 for	 the	 property	 located	 at	</span>
		   <div class="input-box2">
				<input   readonly       type="text" class="form-control" name="username" placeholder=""  align="middle">
		   </div>
		   <span class="text-layout">(Property),	 Escrow	 to	 be	 with from that agreement will be transferred to the property below. The amount owed will increase by $200 or 5% of the outstanding
										balance whichever is greater.</span> -->
           ...
           <div class="input-box3">
				<input   readonly   value="<?php echo agent_name(array('id'=>$ID)) ; ?>"     type="text" class="form-control" name="display_name" placeholder=""  align="middle">
		   </div>
		   <span class="text-layout">(Agent),</span>
		   <div class="input-box">
				<input   readonly   value="<?php echo $request_form_data['broker_name'] ; ?>"     type="text" class="form-control" name="broker_name" placeholder=""  align="middle">
		   </div>
		   <span class="text-layout">(Broker)of</span>          
          
		   <div class="input-box4">
				<input   readonly   value="<?php echo $request_form_data['brokerage_name'] ; ?>"     type="text" class="form-control" name="brokerage_name" placeholder=""  align="middle">
		   </div> 
		   <div class="clearfix"></div>
		   <span class="text-layout">(Brokerage) located at</span> 
		  
		   <div class="input-box5">
				<input   readonly   value="<?php echo $request_form_data['brokerage_address'] ; ?>"     type="text" class="form-control" name="brokerage_address" placeholder=""  align="middle">
		   </div>
		   <div class="clearfix"></div>
		   <span class="text-layout">(Brokerage Address) and CommissionCheckAdvance.com (Company) for the advanced payment of $</span>
		  ...
		  <div class="input-box6">
		   ...
		   <div class="input-box7">
			<input   readonly   value="<?php echo $request_form_data['property_address'].",".$request_form_data['city'].",".$request_form_data['state'].",".$request_form_data['zipcode'] ; ?>"     type="text" class="form-control" name="property_address" placeholder=""  align="middle">
			</div>	
			<span class="text-layout">(Property), Escrow to be with</span> 
			 <div class="input-box8">
			<input   readonly   value="<?php echo $request_form_data['closing_company_name'] ; ?>"     type="text" class="form-control" name="username" placeholder=""  align="middle">
			</div>
			<div class="clearfix"></div>
			<span class="text-layout">Title Company, Escrow Officer</span>
			<div class="input-box9">
			<input   readonly   value="<?php echo $request_form_data['escrow_officer'] ; ?>"     type="text" class="form-control" name="escrow_officer" placeholder=""  align="middle">
			</div>
			<span class="text-layout">Escrow#</span>
			<div class="input-box10">
			<input   readonly   value="<?php echo $request_form_data['escrow_number'] ; ?>"     type="text" class="form-control" name="escrow_number" placeholder=""  align="middle">
			</div>
			<span class="text-layout">Broker shall advance Agent the amount of $</span>
			<div class="input-box11">
			<input   readonly   value="<?php echo $request_form_data['amount_requested'] ; ?>"     type="text" class="form-control" name="amount_requested" placeholder=""  align="middle">
			</div>
			<span class="text-layout">(Advance) upon execution of this agreement. Upon successful Close of Escrow of property in exchange for Advance Company shall collect</span>
			<div class="clearfix"></div>
			<div class="input-box12">

<!--  -----------***************** This is the amount including commission Calculations ******************----------------------        -->			
			<?php  $amount = $request_form_data['sales_price'] ;
				   $commission = (REP_COMMISSION * $amount)/100 ;
				   $commission_amount = ($commission<=200)? 200 : $commission ; 	
				   $total_amount = $request_form_data['sales_price'] + $commission_amount ; ?>
<!--  -----------*****************  Calculations Ends ******************----------------------        -->

			
			<input   readonly   value="<?php echo $total_amount ; ?>"     type="text" class="form-control" name="total_amount_one" placeholder=""  align="middle">
			</div>
			...
			<input   readonly   value="<?php if(!empty($request_form_data['close_date'])){ echo date('m/d/Y',$request_form_data['close_date']) ; }?>"     type="text" class="form-control" name="username" placeholder=""  align="middle">
			</div>
			<div class="clearfix"></div>
			<span class="text-layout">In the event that COE does not take place as scheduled, Company shall take the full commission amount</span>
			<div class="input-box14">
			<input   readonly   value="<?php echo $total_amount ; ?>"     type="text" class="form-control" name="total_amount_two" placeholder=""  align="middle">
			</div>
			<span class="text-layout">from the next property that Agent closes. In the event that the next transaction closed by Agent is not greater than or
				equal to the full commission amount then Company shall take any remaining balance from any subsequent closing(s).</span>
			
			<span class="text-layout">In the event that Agent transfers to a different Brokerage while monies are still owed then Brokerage shall also be bound by this agreement and is hereby instructed to pay any remaining balances
			...
			<span class="text-layout"><strong>Executed By And Between: </strong></span>
			<div  style="width:100%; float:left;"></div>
			
			
			
			
			<span class="text-layout">-Pursuant to a written agreement between</span>
           <div class="input-box15">
				<input   readonly   value="<?php echo $request_form_data['sellers_name'] ; ?>"     type="text" class="form-control" name="sellers_name" placeholder=""  align="middle">
		   </div>
		   <span class="text-layout">as Seller and</span>
		   <div class="input-box16">
				<input   readonly   value="<?php echo $request_form_data['buyers_name'] ; ?>"     type="text" class="form-control" name="buyers_name" placeholder=""  align="middle">
		   </div>
			<span class="text-layout"> as Buyer, Broker has earned a Commission in which Agent has an interest, arising out of the sale of the
					Property.The Commission is payable upon COE.</span>
					
		<span class="text-layout">-As	a	financial	accommodation	to	the	Agent,	Broker	hereby	requests	that Company pay	the	Advance to	
		Agent.</span>
		...
		close	on	the	Closing	Date.</span>
		
		<span class="text-layout">-	Company purchase	of	the	Commission	shall	be	deemed	to	be	a	true	purchase	of	an	account	receivable
...
<div id="lable">
<span class="text-layout">Property:</span><div class="input-box20">
           <input   readonly   value="<?php echo $request_form_data['property_address'].",".$request_form_data['city'].",".$request_form_data['state'].",".$request_form_data['zipcode'] ; ?>"     type="text" class="form-control" name="property_address" placeholder=""  align="middle"></div></div>
           
          <span class="text-layout"> Close Date:</span><div class="input-box21">
           <input   readonly   value="<?php if(!empty($request_form_data['close_date'])){ echo date('m/d/Y',$request_form_data['close_date']) ; }?>"     type="text" class="form-control" name="username" placeholder=""  align="middle"></div>
           
           
           <div class="clearfix"></div>
           <span class="text-layout">Advance Amount:</span><div class="input-box22">
           <input   readonly   value="<?php echo $request_form_data['sales_price'] ; ?>"     type="text" class="form-control" name="sales_price" placeholder=""  align="middle"></div>
           
           
          <div class="clearfix"></div>
           <span class="text-layout">  Fees:</span><div class="input-box23">
           <input   readonly   value="<?php echo $commission_amount ; ?>"     type="text" class="form-control" name="commission_amount" placeholder=""  align="middle"></div>
		   <div class="clearfix"></div>
<span class="text-layout">Total Due at Closing </span><div class="input-box24">
           <input   readonly   value="<?php echo $total_amount; ?>"     type="text" class="form-control" name="total_amount_three" placeholder=""  align="middle"></div>
...
<span class="text-layout">Agent</span><div class="input-box25">
           <input   readonly   value=""     type="text" class="form-control" name="username" placeholder=""  align="middle"></div>
		   <div class="clearfix"></div>
           
          <span class="text-layout"> Broker</span><div class="input-box26">
           <input   readonly   value=""     type="text" class="form-control" name="username" placeholder=""  align="middle"></div>
           
           
           <div class="clearfix"></div>
           <span class="text-layout">Company</span><div class="input-box27">
           <input   readonly   value="<?php echo $request_form_data['closing_company_name'] ; ?>"     type="text" class="form-control" name="username" placeholder=""   align="middle"></div>
    ...
    <div class="panel">
    	<div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                	<span class="text-layout">Escrow#</span>
                    <label  class="text-layout"><?php echo  $request_form_data['escrow_file_number']  ?> </label>
					<!--<div class="input-box">
            ...
            <div class="row">
            	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                	...
                	<label class="text-layout"><?php echo  $request_form_data['escrow_officer'] .' At ' .$request_form_data['closing_company_name'] ;  ?> </label>
                </div>
				
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                	<span class="text-layout">Date:</span>
                     <label  class="text-layout"><?php echo  $request_form_data['created']  ?> </label>
					<!--<div class="input-box">
					<input type="text" class="form-control" name="username" placeholder=""  align="middle">
					</div>-->
                </div>
			...
			<div id="form">
				...
				<div class="row col-border1">
					 ...
					 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 cborder">
                	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                    <label  class="text-layout"><?php echo  $request_form_data['property_address']  ?> </label>
                    	 <!-- <textarea class="form-control" rows="0" id="comment" style="height: 34px;"></textarea>-->
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    	 <span class="text-layout">City:</span>  
                         <label  class="text-layout" ><?php echo  $request_form_data['city']  ?> </label> 
						<!-- <div class="input-box1">
								<input type="text" class="form-control" name="username" placeholder="" align="middle">
						 </div>-->
					</div>
					 <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
						  <span class="text-layout" >State:</span>   
                            <label  class="text-layout" ><?php echo  $request_form_data['state']  ?> </label> 
						<!-- <div class="input-box2">
								<input type="text" class="form-control" name="username" placeholder="" align="middle">
						 </div> -->
				     </div>
					  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
						  <span class="text-layout" >Zip Code:</span>  
                            <label  class="text-layout" ><?php echo  $request_form_data['zipcode']  ?> </label>  
						<!-- <div class="input-box3">
								<input type="text" class="form-control" name="username" placeholder="" align="middle">
						 </div> -->
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                         ...
                         <label  class="text-layout"><?php echo  $request_form_data['broker_name']  ?> </label>   
						<!-- <div class="input-box5">
								<input type="text" class="form-control" name="username" placeholder="" align="middle">
						 </div> -->
                    </div>
			...
			<div class="row col-border1">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                    	 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 cborder">
                             ...
                             <label  class="text-layout"><?php echo  $request_form_data['buyers_name']  ?> </label>  
							 <!--<div class="input-box6">
								<input type="text" class="form-control" name="username" placeholder="" align="middle">
						 </div> -->
						 </div>
						  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                             ...
                             <label  class="text-layout"><?php echo  $request_form_data['sellers_name']  ?> </label>  
							 <!--<div class="input-box7">
								<input type="text" class="form-control" name="username" placeholder="" align="middle">
						 </div> -->
						 </div>
			...
			<div class="row col-border1">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  bborder">
                    	 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							 ...
							 <label  class="text-layout"><?php echo date('m/d/Y', $request_form_data['close_date'] ); ?> </label>  
						 </div>
						   <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
						     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
...
property above by</span>
 <label  class="text-layout"><?php echo  $request_form_data['brokerage_name']  ?> </label>  
  <label  class="text-layout"><?php echo  $request_form_data['closing_company_name']  ?> </label>  
				<!--<div class="input-box9">
...
-->				<span class="text-layout">closing date for this sale is delayed or otherwise extended, causing the Amount to be Disbursed to Commission Check Advance.com to change,</span>
 <label  class="text-layout"><?php echo  $request_form_data['brokerage_name']  ?> </label>  
  ...
  <div class="clearfix"></div>
<div class="row">
<div class="pull" style="padding:1%; "><a href="<?php echo BASEURL ?>/users/change_Status_replacement/0/<?php echo $recored_id ?>/<?php echo $ID; ?>"  class="btn btn-primary"><i class="fa fa-dedent"></i> &nbsp; Deny</a></div>
<div class="pull" style="padding:1%; "><button   value="pdf"  onclick="set_value()"  class="btn green"><i class="fa fa-send"></i> &nbsp; Approved and send to docusign</button></div>
