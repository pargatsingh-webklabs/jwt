            ...
            <div class="portlet-body">
                ...
                <table class="table table-striped table-bordered table-hover" id="sample_1">
                    ...
                    <tbody class="text-center">
                        <?php  $srno=1;
                        foreach ($request_forms as $key => $val) {
                            ?>
                            <tr class="">
			                    <td><?php echo $srno++ ; ?></td>
								<td><a href="<?php echo BASEURL; ?>/users/get_replacement_data/<?php echo $val['id']; ?>/<?php echo $ID ; ?>"><i class="fa fa-eye fa-2x" style="color:#32CD32;"></i></a></td>
								<!--<td><a href="<?php echo BASEURL; ?>/users/get_view_form_replacement/<?php echo $val['id']; ?>/<?php echo $ID ; ?>"><i class="fa fa-eye fa-2x" style="color:#32CD32;"></i></a></td>-->
                                ...
                                <td><!--
                                  <?php if($val['status']==1) { ?>
                                  <a title="Deactivate" onclick="return confirm('Are you sure you want to deny the form')" href='<?php echo BASEURL; ?>/users/change_Status_replacement/0/<?php echo $val['id']; ?>/<?php echo $ID ; ?>'><i class="fa fa-minus-square fa-2x" style="color:#000;"></i></a>
                                  <?php } else if($val['status']==0 ) { ?>
                                  <a title="Activate" onclick="return confirm('Are you sure you want to apporve this form')" href='<?php echo BASEURL; ?>/users/change_Status_replacement/1/<?php echo $val['id']; ?>/<?php echo $ID ; ?>'><i class="fa fa-plus-square fa-2x" style="color:#000;"></i></a>
                                  <?php } ?>-->
                                  <a title="Delete" onclick="return confirm('Are you sire you want to delete this form')" href='<?php echo BASEURL; ?>/users/delete_rep_form/<?php echo $val['id']; ?>/<?php echo $ID ; ?>'><i class="fa fa-trash-o fa-2x" style="color:#DB4D4D;"></i></a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
...
function changestatus(id,uId){
	if(confirm('Are you sure? you want to change status?'))
	{
	  ...
	  window.location = '<?php echo BASEURL.'/users/change_ReplacementStatus/';?>'+id+'/'+status1+'/'+uId;
	 //$("#statusChange").submit();
	}	
}
</script>