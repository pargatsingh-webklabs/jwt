                                    ...
                                    <td colspan="18" class="text-center">
										...
										<?php for($i=1;$i<=$total_pages;$i++){ ?>	
											 <li  class="<?php echo ($curr_page==$i)?'active':''; ?>">
												<a href="javascript:get_filtered_data(<?php echo $i; ?>)"><?php echo $i; ?></a></li>
										<?php } ?>	
											<li>
												<a href="javascript:get_filtered_data(<?php echo ($i-1); ?>)" style="border:1px solid #cdcdcd">Last ›</a></li>
										</ul>
                                    </td>
								</tr>
							<?php } } else{  ?>
